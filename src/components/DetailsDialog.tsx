  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Smart Learn!</DialogTitle>
          <DialogDescription>
            {/* <div className="flex items-center gap-3 my-2">
              <p className="flex items-center">
                ...
                <Link
                  ...
                  href="https://github.com/elliott-chong/Smart Learn"
                >
                  GitHub
                </Link>
              </p>
            ...
            <p className="my-2 mt-4 ">
              ...
              the ordinary and embrace the extraordinary with Smart Learn! Our
